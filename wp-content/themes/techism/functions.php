...
function techism_scripts_styles() {
	...
	/*
	 * Adds slider Javascript in homepage 
	 */
	...
	wp_enqueue_script( 'techism-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '1.0', true );
	...
	wp_enqueue_style( 'techism-ie', get_template_directory_uri() . '/css/ie.css', array( 'techism-style' ), '20121010' );
	
	wp_enqueue_style( 'techism-icon-fonts', get_template_directory_uri() . '/css/genericons.css' );
...
function techism_customize_preview_js() {
	wp_enqueue_script( 'techism-customizer', get_template_directory_uri() . '/js/theme-customizer.js', array( 'customize-preview' ), '20130301', true );
}
...
if ( ! function_exists( 'techism_default_options' ) ) :

/**
 * Returns an array of theme default options.
 *
 */
function techism_default_options() {
	$options = array(
		'slider_disable' => true,
		'slider_cat' => 1,
		'slider_post_no' => 2,
...
if ( ! function_exists( 'techism_get_option' ) ) :
/**
 ...
 *
 */
function techism_get_option( $option ) {
	global $techism_options, $techism_default_options;
	if( ! isset( $techism_default_options ) )
		$techism_default_options = techism_default_options();
	if( ! isset( $techism_options ) )
		$techism_options = get_option( 'techism_theme_options', $techism_default_options );
	if( ! isset( $techism_options[ $option ] ) )
	return $techism_default_options[ $option ];
	return $techism_options[ $option ];
}
endif;
	?>